...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  if (existingUser.avatarPublicId) {
    try { await deleteFromCloudinary(existingUser.avatarPublicId); } catch(e){ console.log(e.message); }
  }
...
const updateCoverImage = asyncHandler(async (req, res) => {
  ...
  if (existingUser.coverImagePublicId) {
    try { await deleteFromCloudinary(existingUser.coverImagePublicId); } catch(e){ console.log(e.message); }
  }
